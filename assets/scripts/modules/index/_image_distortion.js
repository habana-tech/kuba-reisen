...
/***/ function(module, exports, __webpack_require__) {
    ...
    let image = document.querySelector('.hero .slide-item:first-child img');
    
    var canvas = document.createElement('canvas');
    canvas.setAttribute('id','canvas_hero');

    document.querySelector('section.hero-home').appendChild(canvas);
	...
	var textures = [{
	  ...
	  file: '/static/img/dmaps/beach-maps.jpg',
	  name: 'maps',
	  align: textureAlign,
	  scale: { x: 0.3, y: 0.3 }
	}];
	...
	*/
	...
	function updateSize() {
	  var container = document.querySelector('.hero .slide-item');
