...
let hoverEffect = function(opts) {
    ...
    renderer.domElement.setAttribute('id', 'canvas_destinations_'+opts.index);
    renderer.domElement.classList.add('canvas_destinations');
...
imagesTrigger.forEach((img, index)=>img.addEventListener('lazyloaded',
    function(e){
        ...
        document.querySelector('#canvas_destinations_'+index).classList.add('canvas_destinations--ready');
    }));
