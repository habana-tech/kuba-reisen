 ...
 */
final class Version20200219191939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity_description_fragment CHANGE metadata metadata JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE activity_story CHANGE metadata metadata JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE description_fragment ADD metadata JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity_description_fragment CHANGE metadata metadata LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE activity_story CHANGE metadata metadata LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE description_fragment DROP metadata');
    }
}
