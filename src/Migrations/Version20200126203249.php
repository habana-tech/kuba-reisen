 ...
 */
final class Version20200126203249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE destination DROP features_count');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD features_count INT NOT NULL');
    }
}
