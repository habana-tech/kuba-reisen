 ...
 */
final class Version20200206224813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A3DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE description_fragment DROP FOREIGN KEY FK_7E9EF7C83DA5256D');
        $this->addSql('ALTER TABLE description_fragment ADD CONSTRAINT FK_7E9EF7C83DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE destination DROP FOREIGN KEY FK_3EC63EAA3DA5256D');
        $this->addSql('ALTER TABLE destination ADD CONSTRAINT FK_3EC63EAA3DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE dynamic_page DROP FOREIGN KEY FK_575ACC43DA5256D');
        $this->addSql('ALTER TABLE dynamic_page ADD CONSTRAINT FK_575ACC43DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE interest DROP FOREIGN KEY FK_6C3E1A673DA5256D');
        $this->addSql('ALTER TABLE interest ADD CONSTRAINT FK_6C3E1A673DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE region DROP FOREIGN KEY FK_F62F1763DA5256D');
        $this->addSql('ALTER TABLE region ADD CONSTRAINT FK_F62F1763DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dynamic_page DROP FOREIGN KEY FK_575ACC43DA5256D');
        $this->addSql('ALTER TABLE dynamic_page ADD CONSTRAINT FK_575ACC43DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
        $this->addSql('ALTER TABLE interest DROP FOREIGN KEY FK_6C3E1A673DA5256D');
