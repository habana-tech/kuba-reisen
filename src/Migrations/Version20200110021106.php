 ...
 */
final class Version20200110021106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity_story ADD description LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE image ADD base64 LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity_story DROP description');
        $this->addSql('ALTER TABLE image DROP base64');
    }
}
