 ...
 */
final class Version20200110001359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dynamic_page ADD image_id INT DEFAULT NULL, ADD description LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dynamic_page ADD CONSTRAINT FK_575ACC43DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
        $this->addSql('CREATE INDEX IDX_575ACC43DA5256D ON dynamic_page (image_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_575ACC43DA5256D ON dynamic_page');
        $this->addSql('ALTER TABLE dynamic_page DROP image_id, DROP description');
    }
}
