 ...
 */
final class Version20200110064512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interest DROP INDEX UNIQ_6C3E1A673DA5256D, ADD INDEX IDX_6C3E1A673DA5256D (image_id)');
        $this->addSql('ALTER TABLE interest CHANGE image_id image_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interest DROP INDEX IDX_6C3E1A673DA5256D, ADD UNIQUE INDEX UNIQ_6C3E1A673DA5256D (image_id)');
        $this->addSql('ALTER TABLE interest CHANGE image_id image_id INT NOT NULL');
    }
}
