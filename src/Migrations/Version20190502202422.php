 ...
 */
final class Version20190502202422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN fly_ticket BOOLEAN NOT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN self_consider INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN self_character INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN self_luxury INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN message CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN locale VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN request_date_time DATETIME NOT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN request_id VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN client_name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE contact_planing ADD COLUMN client_email VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__interest AS SELECT id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions FROM interest');
        $this->addSql('DROP TABLE interest');
        $this->addSql('CREATE TABLE interest (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, translation_from_id INTEGER DEFAULT NULL, modified_by_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, language VARCHAR(255) NOT NULL COLLATE BINARY, updated_at DATETIME NOT NULL, image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_original_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_mime_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_size INTEGER DEFAULT NULL, image_dimensions CLOB DEFAULT NULL --(DC2Type:simple_array)
        ...
        $this->addSql('INSERT INTO interest (id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions) SELECT id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions FROM __temp__interest');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact_planing (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, travel_date DATETIME NOT NULL, travel_duration VARCHAR(255) DEFAULT NULL, people_amount VARCHAR(255) NOT NULL, travel_budget VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__interest AS SELECT id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions FROM interest');
        $this->addSql('DROP TABLE interest');
        $this->addSql('CREATE TABLE interest (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, translation_from_id INTEGER DEFAULT NULL, modified_by_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, language VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_original_name VARCHAR(255) DEFAULT NULL, image_mime_type VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, image_dimensions CLOB DEFAULT \'NULL --(DC2Type:simple_array)\' COLLATE BINARY --(DC2Type:simple_array)
        )');
        $this->addSql('INSERT INTO interest (id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions) SELECT id, translation_from_id, modified_by_id, title, description, language, updated_at, image_name, image_original_name, image_mime_type, image_size, image_dimensions FROM __temp__interest');
        $this->addSql('DROP TABLE __temp__interest');
        $this->addSql('CREATE INDEX IDX_6C3E1A67D9C220F9 ON interest (translation_from_id)');
