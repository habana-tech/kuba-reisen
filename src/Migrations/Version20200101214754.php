 ...
 */
final class Version20200101214754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE description_fragment (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, destination_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_7E9EF7C83DA5256D (image_id), INDEX IDX_7E9EF7C8816C6140 (destination_id), INDEX IDX_7E9EF7C881C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE description_fragment ADD CONSTRAINT FK_7E9EF7C8816C6140 FOREIGN KEY (destination_id) REFERENCES destination (id)');
        $this->addSql('ALTER TABLE description_fragment ADD CONSTRAINT FK_7E9EF7C881C06096 FOREIGN KEY (activity_id) REFERENCES activity (id)');
        ...
        $this->addSql('ALTER TABLE activity_story ADD image_id INT DEFAULT NULL, ADD active TINYINT(1) DEFAULT NULL, DROP translation_from_id, DROP modified_by_id, DROP published, DROP updated_at, DROP alternative_text, DROP language, DROP image_name, DROP image_original_name, DROP image_mime_type, DROP image_size, DROP image_dimensions, CHANGE metadata metadata JSON DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE destination ADD image VARCHAR(255) NOT NULL, ADD active TINYINT(1) DEFAULT NULL, DROP image_name, DROP image_original_name, DROP image_mime_type, DROP image_size, DROP image_dimensions');
        ...
        $this->addSql('ALTER TABLE filter_tag ADD active TINYINT(1) DEFAULT NULL, ADD priority INT DEFAULT NULL, DROP translation_from_id, DROP modified_by_id, DROP language');
        ...
        $this->addSql('ALTER TABLE interest ADD image_id INT NOT NULL, ADD active TINYINT(1) DEFAULT NULL, ADD priority INT DEFAULT NULL, DROP translation_from_id, DROP modified_by_id, DROP language, DROP updated_at, DROP alternative_text, DROP image_name, DROP image_original_name, DROP image_mime_type, DROP image_size, DROP image_dimensions');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD image_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_original_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_mime_type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_size INT DEFAULT NULL, ADD image_dimensions LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:simple_array)\', DROP image, DROP active');
        $this->addSql('ALTER TABLE filter_tag ADD modified_by_id INT DEFAULT NULL, ADD language VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP active, CHANGE priority translation_from_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE interest ADD modified_by_id INT DEFAULT NULL, ADD language VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD updated_at DATETIME DEFAULT NULL, ADD alternative_text VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_original_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_mime_type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD image_size INT DEFAULT NULL, ADD image_dimensions LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:simple_array)\', DROP image_id, DROP active, CHANGE priority translation_from_id INT DEFAULT NULL');
