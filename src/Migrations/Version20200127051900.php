 ...
 */
final class Version20200127051900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD activity_section_title VARCHAR(255) DEFAULT NULL, ADD activity_section_subtitle VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination DROP activity_section_title, DROP activity_section_subtitle');
    }
}
